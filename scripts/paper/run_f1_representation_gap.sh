...
SUITE_NAME="f1_representation_gap"
MODELS="${MODELS:-qwen2_vl,qwen3_vl,idefics3}"
SEEDS="${SEEDS:-42}"
TASK_GROUPS="${TASK_GROUPS:-all_tasks_current}"
METHOD_GROUPS="${METHOD_GROUPS:-gap_findings}"
SUMMARY_PATH="$PROJECT_ROOT/swap/paper/records/${SUITE_NAME}_${TIMESTAMP}.md"
ANALYSIS_PATH="$PROJECT_ROOT/swap/paper/records/${SUITE_NAME}_${TIMESTAMP}_analysis.md"
EXTRA_NOTIFY_PATHS="$ANALYSIS_PATH"
...
uv run python scripts/paper/analyze_representation_gap.py \
