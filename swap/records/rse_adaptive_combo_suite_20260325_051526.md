...
- Manifest: `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/manifest.tsv`

## Overview

| Dataset | Zero-shot | SAV | RSE | RSE-ZScore | RSE-CV | RSE-Shrink | RSE-AdaptiveOnly | RSE-Adaptive | RSE-Adaptive+PCA | RSE-PCA |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| blink_semantic_correspondence | 0.0286 | 0.1143 | 0.2286 | 0.2000 | 0.2000 | 0.1714 | 0.2000 | 0.2857 | 0.2571 | 0.2286 |
| cub | 0.9500 | 0.9900 | 0.9700 | 0.9700 | 0.9700 | 0.9300 | 0.9600 | 0.9600 | 0.9700 | 0.9700 |
| eurosat | 0.6000 | 0.6600 | 0.5600 | 0.6300 | 0.5900 | 0.5300 | 0.5800 | 0.6600 | 0.6100 | 0.5900 |
| naturalbench_vqa | 0.7375 | 0.8250 | 0.7625 | 0.8000 | 0.7875 | 0.8000 | 0.8000 | 0.8000 | 0.7875 | 0.7875 |
| sugarcrepe | 0.2750 | 0.6750 | 0.4500 | 0.4750 | 0.4750 | 0.5000 | 0.5000 | 0.4750 | 0.4750 | 0.4750 |
| vlguard | 0.7125 | 0.9750 | 0.9250 | 1.0000 | 0.9625 | 0.9750 | 0.9750 | 1.0000 | 1.0000 | 1.0000 |
...
| RSE-AdaptiveOnly | +0.0198 | 4 | 0 | 2 | +0.1186 | -0.0374 |
| RSE-Adaptive | +0.0474 | 5 | 0 | 1 | +0.1462 | -0.0098 |
| RSE-Adaptive+PCA | +0.0339 | 5 | 1 | 0 | +0.1327 | -0.0233 |
...
| RSE-AdaptiveOnly | accuracy=0.2000 | -0.0286 | layer@2 (0.3429) | 8 | 0.3250 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/blink_semantic_correspondence_rse_adaptive_only_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-Adaptive+PCA | accuracy=0.2571 | +0.0286 | attn@6 (0.3714) | 8 | 0.3500 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/blink_semantic_correspondence_rse_adaptive_pca_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-AdaptiveOnly | accuracy=0.9600 | -0.0100 | attn@26 (0.9500) | 8 | 0.9900 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/cub_rse_adaptive_only_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-Adaptive+PCA | accuracy=0.9700 | +0.0000 | attn@27 (0.9400) | 8 | 1.0000 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/cub_rse_adaptive_pca_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-AdaptiveOnly | accuracy=0.5800 | +0.0200 | layer@26 (0.6100) | 8 | 0.5000 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/eurosat_rse_adaptive_only_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-Adaptive+PCA | accuracy=0.6100 | +0.0500 | layer@26 (0.6300) | 8 | 0.5200 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/eurosat_rse_adaptive_pca_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-AdaptiveOnly | accuracy=0.8000 | +0.0375 | attn@21 (0.8250) | 8 | 0.7375 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/naturalbench_vqa_rse_adaptive_only_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-Adaptive+PCA | accuracy=0.7875 | +0.0250 | head@21 (0.8375) | 8 | 0.7375 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/naturalbench_vqa_rse_adaptive_pca_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-AdaptiveOnly | pair_accuracy=0.5000 | +0.0500 | layer@14 (0.8125) | 8 | 0.7500 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/sugarcrepe_rse_adaptive_only_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-Adaptive+PCA | pair_accuracy=0.4750 | +0.0250 | layer@14 (0.8125) | 8 | 0.7250 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/sugarcrepe_rse_adaptive_pca_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-AdaptiveOnly | accuracy=0.9750 | +0.0500 | attn@15 (0.9875) | 8 | 0.9500 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/vlguard_rse_adaptive_only_qwen2_vl_20260325_051526.diagnostics.json` |
...
| RSE-Adaptive+PCA | accuracy=1.0000 | +0.0750 | attn@15 (0.9875) | 8 | 0.9500 | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_051526_rse_adaptive_combo_suite/vlguard_rse_adaptive_pca_qwen2_vl_20260325_051526.diagnostics.json` |
