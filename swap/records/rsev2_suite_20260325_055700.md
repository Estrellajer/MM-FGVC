...
- Manifest: `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/manifest.tsv`

## Overview

| Dataset | Zero-shot | SAV | RSE | RSE-ZScore | RSE-CV | RSE-Shrink | RSE-Adaptive | RSEv2 | RSE-PCA |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| blink_semantic_correspondence | 0.0286 | 0.1143 | 0.2286 | 0.2000 | 0.2000 | 0.1714 | 0.2857 | 0.2286 | 0.2286 |
| cub | 0.9500 | 0.9900 | 0.9700 | 0.9700 | 0.9700 | 0.9300 | 0.9600 | 1.0000 | 0.9700 |
| eurosat | 0.6000 | 0.6600 | 0.5600 | 0.6300 | 0.5900 | 0.5300 | 0.6600 | 0.7600 | 0.5900 |
| naturalbench_vqa | 0.7375 | 0.8250 | 0.7625 | 0.8000 | 0.7875 | 0.8000 | 0.8000 | 0.8250 | 0.7875 |
| sugarcrepe | 0.2750 | 0.6750 | 0.4500 | 0.4750 | 0.4750 | 0.5000 | 0.4750 | 0.7250 | 0.4750 |
| vlguard | 0.7125 | 0.9750 | 0.9250 | 1.0000 | 0.9625 | 0.9750 | 1.0000 | 0.9750 | 1.0000 |
...
| RSEv2 | +0.1029 | 5 | 1 | 0 | +0.2017 | +0.0457 |
...
| RSEv2 | accuracy=0.2286 | +0.0000 | head@7 (0.3429) | 112 | - | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/blink_semantic_correspondence_rsev2_qwen2_vl_20260325_055700.diagnostics.json` |
...
| RSEv2 | accuracy=1.0000 | +0.0300 | head@24 (1.0000) | 112 | - | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/cub_rsev2_qwen2_vl_20260325_055700.diagnostics.json` |
...
| RSEv2 | accuracy=0.7600 | +0.2000 | layer@25 (0.7600) | 112 | - | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/eurosat_rsev2_qwen2_vl_20260325_055700.diagnostics.json` |
...
| RSEv2 | accuracy=0.8250 | +0.0625 | mlp@18 (0.8125) | 112 | - | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/naturalbench_vqa_rsev2_qwen2_vl_20260325_055700.diagnostics.json` |
...
| RSEv2 | pair_accuracy=0.7250 | +0.2750 | attn@24 (0.8625) | 112 | - | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/sugarcrepe_rsev2_qwen2_vl_20260325_055700.diagnostics.json` |
...
| RSEv2 | accuracy=0.9750 | +0.0500 | layer@17 (1.0000) | 112 | - | 0 | `/root/autodl-tmp/FGVC/swap/outputs/20260325_055700_rsev2_suite/vlguard_rsev2_qwen2_vl_20260325_055700.diagnostics.json` |
